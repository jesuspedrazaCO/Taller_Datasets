...
def pregunta_2_evolucion_salarial(df: pd.DataFrame):
...
def pregunta_3_departamentos(df: pd.DataFrame):
...
def pregunta_4_diferencia_salarial(df: pd.DataFrame):
...
def pregunta_5_distribucion_salarial(df: pd.DataFrame):
